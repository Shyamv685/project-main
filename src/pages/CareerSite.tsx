...
import { Eye, Edit, Globe, BarChart3, Settings, Plus } from "lucide-react";
  ...
  return (
    <div className="p-6">
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Career Site</h1>
          <p className="text-gray-600 dark:text-gray-400">Manage your company career website</p>
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow">
        <div className="p-4 border-b border-gray-200 dark:border-gray-700">
          <h2 className="text-lg font-medium text-gray-900 dark:text-white">Career Pages</h2>
        </div>
        ...
        {pages.length === 0 && (
          <div className="p-8 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">No career pages</h3>
            <p className="text-gray-600 dark:text-gray-400">Create your first career page to get started</p>
          </div>
        )}
      </div>
    </div>
